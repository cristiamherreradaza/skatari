        ...
        <div class="card card-custom gutter-b example example-compact">
            ...
            <form action="{{ url('User/guarda') }}" method="POST" id="formularioPersona">
                ...
                <div class="card-body">
                    ...
                    <div class="row">
                        <div class="col-md-12"><h3>Datos del denuniante</h3></div>
                    </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-2">
                            <div class="form-group">
                                <label for="exampleSelect1">Tipo documento <span class="text-danger">*</span></label>
                                <select class="form-control" id="ciudad" name="ciudad">
                                    <option value="Carnet Identidad">Carnet Identidad</option>
                                    <option value="Libreta de Servicio Militar">Libreta de Servicio Militar</option>
                                    <option value="RUA">RUA</option>
                                    <option value="No pasaporta">No pasaporta</option>
                                </select>
                            </div>
                        </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-3">
                            <div class="form-group">
                                <label for="exampleSelect1">Formacion Academica <span
                        ...
                        <div class="col-md-3">
                            <div class="form-group">
                                <label for="exampleInputPassword1">Ocupacion/Profesion</label>
                                <input type="text" class="form-control" id="numero" name="numero" />
                            </div>
                        </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-2">
                            ...
                            <button type="button" class="btn btn-primary mr-2 btn-block" onclick="">Nueva
                                Oficina</button>
                        </div>
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <h3 class="text-info">Residencia Actual</h3>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-3">
                            <div class="form-group">
                                <label fo r="exampleSelect1">Se ubica en <span class="text-danger">*</span></label>
                                <select class="form-control" id="perfil" name="perfil">
                                    <option value="Encargado">Ciudad</option>
                                    <option value="Cliente">Comunidad</option>
                                </select>
                            </div>
                        </div>
                        ...
                        <div class="col-md-3">
                            <div class="form-group">
                                <label for="exampleInputPassword1">Nombre ciudad/comunidad
                                    <span class="text-danger">*</span></label>
                                <input type="text" class="form-control" id="password" name="password" required />
                            </div>
                        </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-3">
                            <div class="form-group">
                                <label for="exampleInputPassword1">Fax
                                    <span class="text-danger">*</span></label>
                                <input type="text" class="form-control" id="password" name="password" required />
                            </div>
                        </div>
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <h3 class="text-danger">Denuncia Empresa</h3>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="form-group">
                                <label for="exampleInputPassword1">Nombre Empresa
                                    <span class="text-danger">*</span></label>
                                <input type="text" class="form-control" id="password" name="password" required />
                            </div>
                        </div>
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <h3 class="text-danger">Denunciado Principal (Persona)</h3>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-3">
                            <div class="form-group">
                                <label for="exampleSelect1">Formacion Academica <span class="text-danger">*</span></label>
                                <select class="form-control" id="ciudad" name="ciudad">
                                    <option value="Primaria">Primaria</option>
                                    <option value="Secundaria">Secundaria</option>
                                    <option value="Universitaria">Universitaria</option>
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <h3 class="text-danger">Motivo</h3>
                        </div>
                    </div>
